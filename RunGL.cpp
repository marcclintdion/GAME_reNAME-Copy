...
void RenderGL(void)
{
       ...
       if(showMarc)
       {
                 if(marcJumping)//is set false in here --->>ME_animationSequencing.cpp
                 {
                           if(resetAnimation)
                           {
                           ...
                           #include "marcAnimations/animationFiles/ME_Animation_JUMP.cpp"
                           #include "marcAnimations/animationFiles/ME_animationSequencing.cpp" //<<--marcJumping is set false here 
                           marcWalking = false;
                 }
                 ...
                 if(marcWalking)
                 {
                           ...
                           #include "marcAnimations/animationFiles/ME_AnimationSet_WALK.cpp"
                           #include "marcAnimations/animationFiles/ME_animationSequencing.cpp" 
                 }                              
       }//END_showMarc
