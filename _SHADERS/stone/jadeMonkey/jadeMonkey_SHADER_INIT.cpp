...
//      "         NdotL3                    =  max(dot(normal, lightPosition_PASS_03.xyz), 0.0);                                                      \n"                       
      ...
      "         gloss_01                  =  vec4(0.9, 1.0, 0.9, 1.0) * max(pow(NdotL1, shininess*.1), 0.0) ;                \n"    
      "         gloss_02                  =  vec4(0.9, 1.0, 0.9, 1.0) * max(pow(NdotL2, shininess*0.8), 0.0) ;            \n"       
      "         gloss_04                  =  vec4(0.9, 1.0, 0.9, 1.0) * max(pow(NdotL4, shininess*0.3), 0.0) ;            \n"       
